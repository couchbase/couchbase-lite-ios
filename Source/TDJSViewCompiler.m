...
- (TDMapBlock) compileMapFunction: (NSString*)mapSource language: (NSString*)language {
    ...
    TDJSFunction* fn = [[TDJSFunction alloc] initWithCompiler: self
...
@implementation TDJSFilterCompiler
...
- (TD_FilterBlock) compileFilterFunction: (NSString*)filterSource language: (NSString*)language {
    ...
    TD_FilterBlock block = ^BOOL(TD_Revision* revision, NSDictionary* params) {
