...
- (void) testReplicatorConfigDefaultValues {
    CBLURLEndpoint* target = [[CBLURLEndpoint alloc] initWithURL: [NSURL URLWithString: @"ws://localhost:4984/db"]];
    CBLCollectionConfiguration* colConfig = [[CBLCollectionConfiguration alloc] initWithCollection: self.defaultCollection];
