...
/** The model name used for registering the CBLCoreMLPredictiveModel model to the CBLDatabase. */
...
/**
 Initializes the CBLCoreMLPredictiveModel with the given model name and the MLModel object.

 @param name The model name.
 @param model The MLModel object.
 */
- (instancetype) initWithName: (NSString*)name model: (MLModel*)model;

/**
 Registers the CBLCoreMLPredictiveModel object to the CBLDatabase with the model name given when
 initializing the CBLCoreMLPredictiveModel object so that the model will be available to use by the
 Predictive Query's prediction() function.
 */
- (void) register;

/**
 Unregisters the CBLCoreMLPredictiveModel from the CBLDatabase.
 */
- (void) unregister;
