...
function usage
{
    echo -e "\nuse:  ${0} release_number  build_number  edition<community|enterprise>  platform<ios|macosx|tvos> \n\n"
}
...
DOC_ZIP_ROOT=${BASE_DIR}/build_doc/Release
