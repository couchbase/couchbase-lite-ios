...
class MultipeerReplicatorTest: CBLTestCase {
    ...
    func startMultipeerReplicator(_ repl: MultipeerReplicator) {
        ...
        repl.start()
        wait(for: [xActive], timeout: CBLTestCase.expTimeout)
        token1.remove()
    }
    ...
    func stopMultipeerReplicator(_ repl: MultipeerReplicator) {
        ...
        repl.stop()
        wait(for: [xInactive], timeout: CBLTestCase.expTimeout)
        token.remove()
    ...
    func waitForReplicatorStatus(for repl: MultipeerReplicator,
                                 ...
                                 timeout: TimeInterval = CBLTestCase.expTimeout) {
        var idleCount = 0
    ...
    func testAuthenticateWithRootCertsFailed() throws {
        ...
        wait(for: [xStopped], timeout: CBLTestCase.expTimeout)
    ...
    func testPeerDiscoveryListener() throws {
        ...
        wait(for: [xPeer2Online, xPeer1Online], timeout: CBLTestCase.expTimeout)
        
        Thread.sleep(forTimeInterval: 1.0)
        
        stopMultipeerReplicator(repl1)
        
        wait(for: [xPeer1Offline], timeout: CBLTestCase.expTimeout)
